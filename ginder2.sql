...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=530248042ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ginder&table=post">`ginder`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ginder&table=profile">`ginder`.`profile`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=csi3140&table=persons">`csi3140`.`persons`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7c2e28374f305e72354d787e2c464e5c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ginder" targettable="profile">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `profile`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ginder" targettable="profile">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">EXPLAIN SELECT * FROM `profile`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ginder" targettable="profile">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `profile`
WHERE fname IS NULL;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ginder" targettable="profile">
                            <div class="action_content">
...
WHERE skill = 0;</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `profile`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="ginder" targettable="post">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `ginder`.`post` ( `gamertag` VARCHAR(50) NOT NULL ,  `gameName` VARCHAR(50) NOT NULL ,  `console` VARCHAR(50) NOT NULL ,  `rank` VARCHAR(50) NOT NULL ,  `description` VARCHAR(200) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ginder" targettable="post">
                            <div class="action_content">
